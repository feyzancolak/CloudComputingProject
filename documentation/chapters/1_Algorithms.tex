...
\begin{algorithm}
    ...
    \Class{Mapper}{}
        ...
        \Statex
        \Procedure{Map}{$\text{docid key, doc value}$}
        ...
        \Statex
        \Procedure{Close}{}
        \For{$\text{each entry } (character, count) \text{ in } \text{charCountMap}$}
    ...
    \Class{Reducer}{}
        ...
        \Procedure{Reduce}{$\text{docid key, values}$}
...
\begin{algorithm}
    ...
    \Class{Mapper}{}
        ...
        \Statex
        \Procedure{Close}{}
        \For{$\text{each entry } (character, count) \text{ in } \text{counts [c1, c2, ...]}$}
        }
            \State $\text{emit(character, count)}$
            \Comment{Output character counts}
        \EndFor
    ...
    \Class{Reducer}{}
        ...
        \Statex
        \Procedure{Reduce}{$\text{Text key, values}}
        \State $\text{long sum} \gets 0$
        \For{$\text{each value } v \text{ in } \text{values}$}
